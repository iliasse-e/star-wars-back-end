...
public class AndriiDavidEveIliasseApplication {
	...
	@Bean
	CommandLineRunner start(RebelleRepository rebelleRepository, ChasseurRepository chasseurRepository, PiloteRepository piloteRepository, MissionService missionService) {
		return args -> {
